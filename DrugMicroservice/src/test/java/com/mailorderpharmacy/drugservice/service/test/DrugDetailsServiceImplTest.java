...
class DrugDetailsServiceImplTest {
	...
	void getAllDrugs() {
		...
		/*
		 * for (final DrugDetails d : drugList) {
		 * 
		 * 
		 * System.out.println(String.valueOf(d.getDrugId()) + " " + d.getDrugName() +
		 * " " + d.getManufacturer() + " " + d.getDruglocationQuantities() + " " +
		 * d.getExpiryDate() + " " + d.getManufactureDate());
		 * 
		 * 
		 * }
		 */
